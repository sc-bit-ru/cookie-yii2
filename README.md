...
Оверлей не вырезает HTML: роботы видят текст страницы. Человек без клика страницу не читает — для всего сайта обычно лучше плашка, оверлей — на каталог или блог, где важно, чтобы выбор не проскроллили.
